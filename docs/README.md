...
Current focus has moved to Phase 3 operations UI and hardening (test coverage, observability, and reliability).
...
## Document Categories
### Core Governance
- `.cursor/rules/RULES.md` - authoritative project rules and implementation guardrails.
- `.cursor/rules/AGENTS.md` - lightweight pointer to the authoritative rule set.
- `PLAN.md` - active execution tracking by phase and priority.
...
- `product/implementation-roadmap.md` - milestone sequencing and dependencies.
