...
export function HomeSection({ phase, planStatus, projectSummary, roadmapMarkdown, sourceLabel }) {
    ...
    const featureCards = useMemo(() => extractRoadmapFeatures(roadmapMarkdown, phase), [roadmapMarkdown, phase]);
    ...
    return (_jsxs(SectionShell, { id: "home", title: "Home", sourceLabel: sourceLabel, children: [_jsxs("div", { className: styles.hero, children: [_jsxs("div", { children: [_jsx("span", { className: styles.eyebrow, children: "Portfolio Dashboard" }), _jsx("h3", { children: "Execution Overview" }), _jsx("p", { children: projectSummary })] }), _jsxs("div", { className: styles.heroPhase, children: [_jsx("span", { className: styles.heroLabel, children: "Active Feature" }), _jsx("div", { className: "phase", children: phase })] })] }), _jsx("div", { className: `kpi-grid ${styles.kpis}`, children: kpis.map((kpi) => (_jsxs("div", { className: "kpi", children: [_jsx("span", { className: "value", children: kpi.value }), _jsx("span", { className: "label", children: kpi.label })] }, kpi.label))) }), _jsx("div", { className: `card-grid ${styles.summaryGrid}`, children: cards.map((card) => (_jsxs("article", { className: "card", children: [_jsx("h3", { children: card.title }), card.isPhase ? _jsx("div", { className: "phase", children: card.text }) : _jsx("p", { children: card.text })] }, card.title))) }), _jsxs("div", { className: styles.sectionBlock, children: [_jsxs("div", { className: styles.blockHeader, children: [_jsx("h3", { children: "Feature Dashboard" }), _jsx("p", { children: "Roadmap features rendered as Azure-style cards." })] }), _jsx(PhaseDashboard, { phases: featureCards })] }), _jsxs("div", { className: styles.sectionBlock, children: [_jsxs("div", { className: styles.blockHeader, children: [_jsx("h3", { children: "PBI and Tasks" }), _jsx("p", { children: "Filter execution work by status and feature while keeping the current PBI visible." })] }), _jsx(StatusFilters, { phaseFilter: phaseFilter, phaseOptions: featureOptions, statusFilter: statusFilter, totalCount: workItems.length, visibleCount: filteredItems.length, onPhaseChange: setPhaseFilter, onStatusChange: setStatusFilter }), _jsx(WorkItemsBoard, { items: filteredItems, pbiTitle: phase })] }), _jsx("div", { className: `card-grid ${styles.quickLinks}`, children: quickLinks.map(([label, href]) => (_jsxs("a", { className: "card", href: href, children: [_jsx("h3", { children: label }), _jsx("p", { children: "Open section" })] }, label))) })] }));
}
