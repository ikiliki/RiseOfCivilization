...
export const mockContent: DocsPortalContent = {
  ...
  sources: {
    ...
    plan: 'PLAN.md',
    changelog: 'docs/changelog-session-summary.md'
  },
  docs: {
    docsReadme:
      '# Documentation Index\n\n## Project Summary\nRise Of Civilization is in active implementation with a shared world, deterministic generation, and Phase 2 multiplayer foundation work.',
    mvp:
    ...
    plan:
      '# Project Plan\n\n## Current Phase\n- Phase 2: Multiplayer Shared-World Foundation',
    changelog:
      '# Session Summary\n\n## 1. Presence\n### WebSocket Layer\n### Nearby Broadcast\n\n## 2. Inspect\n### Profile Panel\n### Player Query'
  },
  planStatus: {
    phase: 'Phase 3: Operations UI and Hardening',
    completed: [
      'Monorepo scaffold completed.',
      'Client runtime implemented.',
      'Phase 2 + 2.5 realtime foundation implemented.'
    ],
